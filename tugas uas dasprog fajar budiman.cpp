...
const char nama[]="NAMA : Fajar Budiman";
		...
		char kelas[]="NAMA : REGULAR";
		
	int kode,jode2,setor,saldo;
	char lagi;
	string pass;
...
cout<<" "<<endl;
cout<<"1. Rp. 500.000				2. 1.000.000"<<endl;
cout<<endl;
cout<<endl;
cout<<endl;
...
switch (jode2)
		{
			...
			saldo=saldo-tarik[0];
			cout<<""<<endl;
			cout<<"Sisa saldo		: Rp.100.000.000 "<<saldo<<",-";
			cout<<""<<endl;
			cout<<""<<endl;
			...
			saldo=saldo-tarik[1];
			cout<<""<<endl;
			cout<<"sisa saldo	: Rp.300.000.000 "<<saldo<<",-";
			cout<<""<<endl;
...
cout << endl;
cout << endl;
cout << "Masukkan jumlah yang anda ingin setorkan :" << endl;
